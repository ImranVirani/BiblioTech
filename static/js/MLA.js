function displayEntry() {
    ...
    if (formatType = "chicago") {
        var entry = document.getElementById("result-entry" + entryNumber).innerHTML += authorLastName + ", " + authorFirstName + '. "' + articleTitle + '." ' + "<em>" + publisherName + "</em>" + " " + dayPublished + " " + monthPublished + " " + yearPublished + " " + urlOfSource + " " + "Accessed " + dateOfAccess;
